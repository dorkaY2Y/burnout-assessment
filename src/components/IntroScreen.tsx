...
const COPY = {
  hu: {
    ...
    intro1: 'A Y2Y Burnout Compass két nemzetközileg validált tudományos skála kombinációján alapul. Nem egy kvíz — hanem egy klinikai kutatásban tesztelt mérőeszköz, amelyet az Y2Y leadership kontextusra adaptált.',
  ...
  en: {
    ...
    intro1: 'The Y2Y Burnout Compass is built on a combination of two internationally validated scientific scales. Not a quiz — but a clinically tested measurement tool, adapted by Y2Y for leadership contexts.',
  ...
  de: {
    ...
    intro1: 'Der Y2Y Burnout Compass basiert auf der Kombination zweier international validierter wissenschaftlicher Skalen. Kein Quiz — sondern ein klinisch getestetes Messinstrument, das von Y2Y für Leadership-Kontexte adaptiert wurde.',
